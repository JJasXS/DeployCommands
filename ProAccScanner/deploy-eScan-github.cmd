...
title ProAcc eScan Deploy (GitHub)

REM =============================================================================
REM ProAcc eScan (ProAccScanner) -- full Windows deploy from GitHub
...
set "REPO_URL=https://github.com/JJasXS/ProAccScanner.git"
set "GIT_BRANCH=main"
...
cd /d "%~dp0"
echo.
echo [%DATE% %TIME%] eScan deploy GitHub (Administrator)
echo Script: %~f0
echo Folder: %~dp0
echo.
