...
title ApprovalPO Deploy (GitHub)

REM =============================================================================
REM ApprovalPO (e-Approval) -- full Windows deploy from GitHub
...
set "REPO_URL=https://github.com/JJasXS/ApprovalPO.git"
set "GIT_BRANCH=main"
...
echo.
echo [%DATE% %TIME%] ApprovalPO deploy GitHub (Administrator)
echo Script: %~f0
echo Log:    %DEPLOY_LOG%
echo.
