...
title SqlAccountSync Deploy (GitHub)

REM =============================================================================
REM SqlAccountSync (multiDBSync) -- full Windows deploy from GitHub
...
set "REPO_URL=https://github.com/JJasXS/multiDBSync.git"
...
cd /d "%~dp0"
echo.
echo [%DATE% %TIME%] SqlAccountSync deploy GitHub (Administrator)
echo Script: %~f0
echo Folder: %~dp0
echo.
