...
title ABS System Deploy (GitLab)

REM =============================================================================
REM ABS System (e-Booking) -- full Windows deploy from GitLab
...
REM SSH form (often blocked on port 22): git@gitlabsvr.oneclickclouds.com:softwaredevelopment/ABS_System.git
set "REPO_URL=https://gitlabsvr.oneclickclouds.com/softwaredevelopment/ABS_System.git"
...
cd /d "%~dp0"
echo.
echo [%DATE% %TIME%] ABS System deploy GitLab (Administrator)
echo Script: %~f0
echo Folder: %~dp0
echo.
...
if exist "%APP_DIR%\.env" (
  ...
  (
    echo # ABS System / e-Booking - required for OTP email via AWS Secrets Manager
    echo TENANT_CODE=
    echo AWS_REGION=ap-southeast-1
    echo AWS_ACCESS_KEY_ID=
    echo AWS_SECRET_ACCESS_KEY=
