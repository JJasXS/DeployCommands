...
title autoEmailing Deploy (GitLab)

REM =============================================================================
REM SQL Accounting Email Worker (autoEmailing) -- full Windows deploy from GitLab
...
REM SSH form (often blocked on port 22): git@gitlabsvr.oneclickclouds.com:softwaredevelopment/autoEmailing.git
set "REPO_URL=https://gitlabsvr.oneclickclouds.com/softwaredevelopment/autoEmailing.git"
set "GIT_BRANCH=main"
...
cd /d "%~dp0"
echo.
echo [%DATE% %TIME%] autoEmailing deploy GitLab (Administrator)
echo Script: %~f0
echo Folder: %~dp0
echo.
...
echo [3/8] Clone GitLab branch %GIT_BRANCH%...
echo   URL: %REPO_URL%
